...
const create = async(userId, view) => {
  ...
  await sendConfirmation({
    ...
    system_health_ok: values.system_health_block.system_health_ok.value,
    system_health_note:
      values.system_health_note_block.system_health_note.value,
    alerts_ok: values.alerts_block.alerts_ok.value,
    ...
    ringmap_ok: values.ringmap_block.ringmap_ok.value,
